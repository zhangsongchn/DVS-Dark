...
class InterconnectLink :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.InterconnectLink) */ {
 public:
  InterconnectLink();
...
class LocalLinks :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.LocalLinks) */ {
 public:
  LocalLinks();
  virtual ~LocalLinks();
...
class DeviceLocality :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.DeviceLocality) */ {
 public:
  DeviceLocality();
...
class DeviceAttributes :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.DeviceAttributes) */ {
 public:
  DeviceAttributes();

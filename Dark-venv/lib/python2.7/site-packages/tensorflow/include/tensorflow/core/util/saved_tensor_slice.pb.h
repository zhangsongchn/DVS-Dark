...
void AddDescriptors_tensorflow_2fcore_2futil_2fsaved_5ftensor_5fslice_2eproto();
...
class SavedSliceMeta :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.SavedSliceMeta) */ {
 public:
  SavedSliceMeta();
...
class SavedTensorSliceMeta :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.SavedTensorSliceMeta) */ {
 public:
...
class SavedSlice :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.SavedSlice) */ {
 public:
  SavedSlice();
  virtual ~SavedSlice();
...
class SavedTensorSlices :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.SavedTensorSlices) */ {
 public:
  SavedTensorSlices();

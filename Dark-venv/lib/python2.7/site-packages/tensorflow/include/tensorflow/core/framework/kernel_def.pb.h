...
class KernelDef_AttrConstraint :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.KernelDef.AttrConstraint) */ {
 public:
...
class KernelDef :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.KernelDef) */ {
 public:
  KernelDef();
  virtual ~KernelDef();
...
class KernelList :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.KernelList) */ {
 public:
  KernelList();
  virtual ~KernelList();

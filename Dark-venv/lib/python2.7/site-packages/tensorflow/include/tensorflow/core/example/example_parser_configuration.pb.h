...
void AddDescriptors_tensorflow_2fcore_2fexample_2fexample_5fparser_5fconfiguration_2eproto();
...
class VarLenFeatureProto :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.VarLenFeatureProto) */ {
 public:
  VarLenFeatureProto();
...
class FixedLenFeatureProto :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.FixedLenFeatureProto) */ {
 public:
...
class FeatureConfiguration :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.FeatureConfiguration) */ {
 public:
...
class ExampleParserConfiguration :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.ExampleParserConfiguration) */ {
 public:

...
class DeviceProperties :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.DeviceProperties) */ {
 public:
  DeviceProperties();
...
class NamedDevice :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.NamedDevice) */ {
 public:
  NamedDevice();
  virtual ~NamedDevice();

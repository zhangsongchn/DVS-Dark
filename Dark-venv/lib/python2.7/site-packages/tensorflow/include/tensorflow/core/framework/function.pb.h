...
class FunctionDefLibrary :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.FunctionDefLibrary) */ {
 public:
  FunctionDefLibrary();
...
class FunctionDef_ArgAttrs_AttrEntry_DoNotUse : public ::google::protobuf::internal::MapEntry<FunctionDef_ArgAttrs_AttrEntry_DoNotUse, 
    ::std::string, ::tensorflow::AttrValue,
    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
    0 > {
...
static bool _ParseMap(const char* begin, const char* end, void* object, ::google::protobuf::internal::ParseContext* ctx);
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
  typedef ::google::protobuf::internal::MapEntry<FunctionDef_ArgAttrs_AttrEntry_DoNotUse, 
    ::std::string, ::tensorflow::AttrValue,
    ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
    ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
    0 > SuperType;
  FunctionDef_ArgAttrs_AttrEntry_DoNotUse();
  FunctionDef_ArgAttrs_AttrEntry_DoNotUse(::google::protobuf::Arena* arena);
...
class FunctionDef_ArgAttrs :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.FunctionDef.ArgAttrs) */ {
 public:
  ...
  FunctionDef_ArgAttrs* New(::google::protobuf::Arena* arena) const final {
...
class FunctionDef_ArgAttrEntry_DoNotUse : public ::google::protobuf::internal::MapEntry<FunctionDef_ArgAttrEntry_DoNotUse, 
...
static bool _ParseMap(const char* begin, const char* end, void* object, ::google::protobuf::internal::ParseContext* ctx);
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
  typedef ::google::protobuf::internal::MapEntry<FunctionDef_ArgAttrEntry_DoNotUse, 
    ::google::protobuf::uint32, ::tensorflow::FunctionDef_ArgAttrs,
    ::google::protobuf::internal::WireFormatLite::TYPE_UINT32,
    ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
    0 > SuperType;
  FunctionDef_ArgAttrEntry_DoNotUse();
  FunctionDef_ArgAttrEntry_DoNotUse(::google::protobuf::Arena* arena);
...
class FunctionDef :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.FunctionDef) */ {
 public:
  FunctionDef();
  virtual ~FunctionDef();
...
class GradientDef :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.GradientDef) */ {
 public:
  GradientDef();
  virtual ~GradientDef();
